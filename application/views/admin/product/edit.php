              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <select name="media_type" id="media_type" class="form-control" value="<?php echo $product->media_type; ?>">
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="part_number" id="part_number" type="text"  class="form-control" placeholder="part_number" value="<?php echo $product->part_number; ?>">
                      </div>
                    </div>  
                    <div class="row form-row">
                      <div class="col-md-12">
