                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                                <td>
                                    <div class="checkbox check-default">
                                        <input id="checkbox<?php echo $media->id ?>" type="checkbox" name="checkAll[]" class="checkParam" value="<?php echo $media->id; ?>">
                                        <label for="checkbox<?php echo $media->id ?>"></label>
                                    </div>
                                </td>
                                <td align="left"><?php echo $media->title ; ?></td>
                                <td><?php echo $media->media_type; ?></td>
                                <td><img src="/uploads/<?php echo $media->media_img; ?>" width="100" height="100" alt="<?php echo $media->title; ?>" class="img-thumbnail"></td>
                                <td>
                                    <?php if ($media->status == 'DEACTIVE'): ?><a class="singleStatus" href="/admin/media/status/<?php echo $media->id; ?>">
                                    <span class="label label-important">Deactive</span></a>
                                    <?php else: ?><a class="singleStatus" href="/admin/media/status/<?php echo $media->id; ?>">
